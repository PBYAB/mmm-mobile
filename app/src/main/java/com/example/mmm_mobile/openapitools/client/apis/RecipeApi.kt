...
import org.openapitools.client.models.CanUserShakeRecipeDTO
...
class RecipeApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    suspend fun canShakeRecipe() : CanUserShakeRecipeDTO = withContext(Dispatchers.IO) {
        val localVarResponse = canShakeRecipeWithHttpInfo()

        return@withContext when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as CanUserShakeRecipeDTO
     ...
     * 
     * 
     * @return ApiResponse<CanUserShakeRecipeDTO?>
     * @throws IllegalStateException If the request is not correctly configured
     * @throws IOException Rethrows the OkHttp execute method exception
     */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    suspend fun canShakeRecipeWithHttpInfo() : ApiResponse<CanUserShakeRecipeDTO?> = withContext(Dispatchers.IO) {
        val localVariableConfig = canShakeRecipeRequestConfig()

        return@withContext request<Unit, CanUserShakeRecipeDTO>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation canShakeRecipe
     *
     * @return RequestConfig
     */
    fun canShakeRecipeRequestConfig() : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/api/v1/recipes/user/recipe-of-the-day/can-shake",
